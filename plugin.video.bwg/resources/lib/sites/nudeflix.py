...
def NFMain():
    utils.addDir('[COLOR white]Categories[/COLOR]','http://www.nudeflix.com/browse',44,'','')
    utils.addDir('[COLOR white]HD[/COLOR]','http://www.nudeflix.com/browse/cover?order=hd&page=1',41,'',1)
