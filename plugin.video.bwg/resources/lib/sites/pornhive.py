...
def PHMain():
    utils.addDir('[COLOR white]Categories[/COLOR]','http://www.pornhive.tv/en/categories',73,'','')
    utils.addDir('[COLOR white]Search[/COLOR]','http://www.pornhive.tv/en/search?keyword=',74,'','')
