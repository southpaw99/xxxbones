...
def check(scraper):
    ...
    # try:
        ...
        # if ( not disable_check == 'true' ): 
            # scraperFile = xbmc.translatePath(os.path.join('special://home/addons/script.wankbank.scrapers', 'lib/scrapers/%s.py' % scraper.lower()))
            # scraperLink = 'https://raw.githubusercontent.com/echocoderxbmc/script.wankbank.scrapers/master/lib/scrapers/%s.py' % scraper.lower()
            ...
            # if len(r)>1:
                ...
                # if 'import' in r:
                    ...
                    # else:
                        ...
                        # icon = xbmc.translatePath(os.path.join('special://home/addons/script.wankbank.artwork', 'resources/art/%s/icon.png' % scraper.lower()))
