...
def YFTMain():
    utils.addDir('[COLOR white]Categories[/COLOR]','https://www.yourfreetube.net/',193,'','')
    utils.addDir('[COLOR white]Search[/COLOR]','http://www.yourfreetube.net/search.php?keywords=',194,'','')
