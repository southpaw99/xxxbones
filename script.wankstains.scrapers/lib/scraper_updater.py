    ...
    return
     try:
         ...
         if ( not disable_check == 'true' ): 
             scraperFile = xbmc.translatePath(os.path.join('special://home/addons/script.wankstains.artwork', 'lib/scrapers/%s.py' % scraper.lower()))
             scraperLink = 'https://raw.githubusercontent.com/stitches5150/xxxbones/script.wankstains.artwork/master/lib/scrapers/%s.py' % scraper.lower()
             ...
             if len(r)>1:
                 ...
                 if 'import' in r:
                     if compfile == r: 
                         ...
                         icon = xbmc.translatePath(os.path.join('special://home/addons/script.wankstains.artwork', 'resources/art/%s/icon.png' % scraper.lower()))
