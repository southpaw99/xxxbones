...
def animeidhentai_main():
    utils.addDir('[COLOR white]Uncensored[/COLOR]','https://animeidhentai.com/genres/uncensored/', 661, '', '')
    utils.addDir('[COLOR white]Search[/COLOR]','https://animeidhentai.com/?s=', 664, '', '')
