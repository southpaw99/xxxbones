...
if action == None:
    from resources.lib.indexers import TAD
    TAD.indexer().root()
    ...
    from resources.lib.indexers import TAD
    TAD.indexer().getq(url)

elif action == 'xdirectory':
    from resources.lib.indexers import TAD
    TAD.indexer().getx(url)

elif action == 'developer':
    from resources.lib.indexers import TAD
    TAD.indexer().developer()

elif action == 'tvtuner':
    from resources.lib.indexers import TAD
    TAD.indexer().tvtuner(url)

elif 'youtube' in str(action):
    from resources.lib.indexers import TAD
    TAD.indexer().youtube(url, action)

elif action == 'play':
    from resources.lib.indexers import TAD
    TAD.player().play(url, content)

elif action == 'browser':
    from resources.lib.indexers import TAD
    TAD.resolver().browser(url)
    ...
    from resources.lib.indexers import TAD
    TAD.indexer().addSearch(url)

elif action == 'delSearch':
    from resources.lib.indexers import TAD
    TAD.indexer().delSearch()
