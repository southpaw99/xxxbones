...
def Main():
    utils.addDir('[COLOR white]Search[/COLOR]','https://www.hdzog.com/search/?q=', 343, '', '')
    utils.addDir('[COLOR white]Categories[/COLOR]','https://www.hdzog.com/categories/', 344, '', '')
    utils.addDir('[COLOR white]Channels[/COLOR]','https://www.hdzog.com/channels/', 345, '', '')
    utils.addDir('[COLOR white]Models[/COLOR]','https://www.hdzog.com/models/', 346, '', '')
