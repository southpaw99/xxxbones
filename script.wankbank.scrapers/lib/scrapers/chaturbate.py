...
chaturbate_icon = xbmc.translatePath(os.path.join('special://home/addons/script.wankbank.artwork/resources/art/', 'main/chaturbate.png'))
...
def menu():
    ...
    dirlst = []
    icon = xbmc.translatePath(os.path.join('special://home/addons/script.wankbank.artwork', 'resources/art/main/%s.png' % filename))
