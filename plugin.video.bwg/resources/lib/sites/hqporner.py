...
def HQMAIN():
    utils.addDir('[COLOR white]Categories[/COLOR]','https://hqporner.com/porn-categories.php',153,'','')
    utils.addDir('[COLOR white]Studios[/COLOR]','https://hqporner.com/porn-studios.php',153,'','')
    utils.addDir('[COLOR white]Girls[/COLOR]','https://hqporner.com/porn-actress.php',153,'','')
    utils.addDir('[COLOR white]Search[/COLOR]','https://hqporner.com/?s=',154,'','')
