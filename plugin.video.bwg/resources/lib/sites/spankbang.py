...
def Main():
    utils.addDir('[COLOR white]Search[/COLOR]','https://spankbang.com/s/', search_mode, '', '')
    utils.addDir('[COLOR white]Categories[/COLOR]','https://spankbang.com/categories', categories_mode, '', '')
