...
def EXMain():
    utils.addDir('[COLOR white]Categories[/COLOR]','http://elreyx.com/index1.html',113,'','')
    utils.addDir('[COLOR white]Search[/COLOR]','http://elreyx.com/search-',114,'','')
    utils.addDir('[COLOR white]Pornstars[/COLOR]','http://elreyx.com/index1.html',115,'','')
    utils.addDir('[COLOR white]Movies[/COLOR]','http://elreyx.com/index1.html',116,'','')
