...
def BGMain():
    ...
    utils.addDir('[COLOR white]Categories[/COLOR]','https://beeg.com/api/v6/'+bgversion+'/index/main/0/pc',83,'','')
    utils.addDir('[COLOR white]Search[/COLOR]','https://beeg.com/api/v6/'+bgversion+'/index/main/0/pc?query=',84,'','')
