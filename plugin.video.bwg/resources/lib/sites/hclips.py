...
'''
    ...
    Copyright (C) 2018  WhiteGoo, anton40, holisticdioxide
...
def Main():
    utils.addDir('[COLOR white]Search[/COLOR]','http://www.hclips.com/search/?p=0&q=', 384, '', '')
    utils.addDir('[COLOR white]Categories[/COLOR]','http://www.hclips.com/categories/', 383, '', '')
    utils.addDir('[COLOR white]Channels[/COLOR]','http://www.hclips.com/channels/', 385, '', '')
