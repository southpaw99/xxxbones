...
def Main():
    utils.addDir('[COLOR white]Search[/COLOR]','http://justporn.to/?s=', 244, '', '')
    utils.addDir('[COLOR white]Movies[/COLOR]','http://justporn.to/category/dvdrips-full-movies/', 245, '', '')
...
def MainMovies():
    utils.addDir('[COLOR white]Search[/COLOR]','http://justporn.to/?s=', 244, '', '')
    utils.addDir('[COLOR white]Scenes[/COLOR]','http://justporn.to/category/scenes/', 240, '', '')
