...
def yourporn_main():
    utils.addDir('[COLOR white]Watch live stream[/COLOR]','https://yourporn.sexy/live/', 652, '', '')
    utils.addDir('[COLOR white]Categories[/COLOR]','https://yourporn.sexy/', 653, '', '')
    utils.addDir('[COLOR white]Top networks[/COLOR]','https://yourporn.sexy/', 654, '', '', section='networks')
    utils.addDir('[COLOR white]Top pornstars[/COLOR]','https://yourporn.sexy/', 654, '', '', section='pornstars')
    utils.addDir('[COLOR white]Top rated last week[/COLOR]','https://yourporn.sexy/popular/top-rated.html', 651, '', section='rating')
    utils.addDir('[COLOR white]Top viewed last week[/COLOR]','https://yourporn.sexy/popular/top-viewed.html', 651, '', section='views')
    utils.addDir('[COLOR white]Orgasmic[/COLOR]','https://yourporn.sexy/orgasm/', 651, '', section='orgasmic')
    utils.addDir('[COLOR white]Search[/COLOR]','https://yourporn.sexy/', 655, '', '')
