'''
    ...
    Copyright (C) 2018  WhiteGoo, Fr33m1nd, holisticdioxide
...
def Main():
    utils.addDir('[COLOR white]Tags[/COLOR]','http://www.xvideospanish.net/tags/',133,'','')
    utils.addDir('[COLOR white]Categories[/COLOR]','http://www.xvideospanish.net/videos-pornos-por-productora-gratis/',135,'','')
    utils.addDir('[COLOR white]Actors[/COLOR]','http://www.xvideospanish.net/actors/',136,'','')
    utils.addDir('[COLOR white]Search[/COLOR]','http://www.xvideospanish.net/?s=',134,'','')
