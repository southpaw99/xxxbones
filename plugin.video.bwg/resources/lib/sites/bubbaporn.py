...
def TPMain():
    utils.addDir('[COLOR white]Categories[/COLOR]','http://www.bubbaporn.com/channels/',93,'','')
    utils.addDir('[COLOR white]Pornstars[/COLOR]','http://www.bubbaporn.com/pornstars/page1.html',95,'','')
    utils.addDir('[COLOR white]Top Rated[/COLOR]','http://www.bubbaporn.com/top-rated/a/page1.html',91,'','')
    utils.addDir('[COLOR white]Most Viewed[/COLOR]','http://www.bubbaporn.com/most-viewed/a/page1.html',91,'','')
    utils.addDir('[COLOR white]Search[/COLOR]','http://www.bubbaporn.com/search/page1.html?q=',94,'','')
