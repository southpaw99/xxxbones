...
search_icon = xbmc.translatePath(os.path.join('special://home/addons/script.wankstains.artwork/resources/art/', 'main/search.png'))
...
def searchHistory(name,url):
    ...
    lst = [('New Search...',mode,'null','Search Kodibox Adult',True),('Clear History',15,'url',None,False), \
