'''
    ...
    Copyright (C) 2017  WhiteGoo, hdgdl
...
def Main():
    ...
    utils.addDir('[COLOR white]Female[/COLOR]','http://tools.bongacams.com/promo.php?c=226355&type=api&api_type=json&categories[]=female',521,'','')
    utils.addDir('[COLOR white]Male[/COLOR]','http://tools.bongacams.com/promo.php?c=226355&type=api&api_type=json&categories[]=male',521,'','')
    utils.addDir('[COLOR white]Transsexual[/COLOR]','http://tools.bongacams.com/promo.php?c=226355&type=api&api_type=json&categories[]=transsexual',521,'','')
    utils.addDir('[COLOR white]Couples[/COLOR]','http://tools.bongacams.com/promo.php?c=226355&type=api&api_type=json&categories[]=couples',521,'','')
