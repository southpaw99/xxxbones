...
def NLTUBES(url, page=1):
    ...
    utils.addDir('[COLOR white]Categories[/COLOR]', siteurl + '/categorieen',103,'', page)
    if page == 0:
        utils.addDir('[COLOR white]Search[/COLOR]', siteurl + '/pornofilms/zoeken/',104,'', page)
    else:
        utils.addDir('[COLOR white]Search[/COLOR]', siteurl + '/videos/zoeken/',104,'', page)
