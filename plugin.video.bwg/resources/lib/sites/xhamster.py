'''
    ...
    Copyright (C) 2016  WhiteGoo, hdgdl, holisticdioxide
...
def Main():
    utils.addDir('[COLOR white]Categories - Straight[/COLOR]','https://xhamster.com/categories',508,'','')
    utils.addDir('[COLOR white]Categories - Gay[/COLOR]','https://xhamster.com/gay/categories',508,'','')
    utils.addDir('[COLOR white]Categories - Shemale[/COLOR]','https://xhamster.com/shemale/categories',508,'','')
    utils.addDir('[COLOR white]Search[/COLOR]','https://xhamster.com/search.php?q=',509,'','')
...
def List(url):
	...
	for video, hd, img, name, length in match:
		...
		name = utils.cleantext(name) + hd + ' [COLOR white]' + length + '[/COLOR]'
