...
download_icon = xbmc.translatePath(os.path.join('special://home/addons/script.wankstains.artwork/resources/art/main', 'downloads.png'))
    ...
    if downloadableLink:
        ...
        if urlresolver.HostedMediaFile(url).valid_url(): 
            ...
            try:
                ...
                kodi.notify(msg='Something went wrong!  | %s' % str(e), duration=8000, sound=True)
                quit()
            log_utils.log('%s returned by Kodibox Adult backup resolver.' % (u), log_utils.LOGNOTICE)
