...
def v7_main():
    utils.addDir('[COLOR white]Studios[/COLOR]','http://www.vidz7.com/category/', 644, '', '')
    utils.addDir('[COLOR white]Tags[/COLOR]','http://www.vidz7.com/tags/', 644, '', '')
    utils.addDir('[COLOR white]Search[/COLOR]','http://www.vidz7.com/', 645, '', '')
