...
def ypp_main():
    utils.addDir('[COLOR white]Categories[/COLOR]','https://yespornplease.com/categories', 693, '', '')
    utils.addDir('[COLOR white]Search[/COLOR]','https://yespornplease.com/search?q=', 694, '', '')
    Sort = '[COLOR white]Current sort:[/COLOR] ' + sortlistwxf[int(utils.addon.getSetting("sortwxf"))]
