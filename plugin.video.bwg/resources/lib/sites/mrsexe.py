...
def Main():
    utils.addDir('[COLOR white]Classiques[/COLOR]','http://www.mrsexe.com/classiques/', 401, '', '')
    utils.addDir('[COLOR white]Search[/COLOR]','http://www.mrsexe.com/?search=', 404, '', '')
    utils.addDir('[COLOR white]Categories[/COLOR]','http://www.mrsexe.com/', 403, '', '')
    utils.addDir('[COLOR white]Stars[/COLOR]','http://www.mrsexe.com/filles/', 405, '', '')
