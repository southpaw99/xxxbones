'''
    ...
    Copyright (C) 2016  WhiteGoo, hdgdl
...
def Main():
    utils.addDir('[COLOR white]Categories[/COLOR]','https://daftsex.com/categories',614,'','')
    utils.addDir('[COLOR white]Search[/COLOR]','https://daftsex.com/video/',613,'','')
...
def List(url, page=0):
    ...
    for video, img, name, length in match:
        ...
        name = utils.cleantext(name) + ' [COLOR white]' + length + '[/COLOR]'
