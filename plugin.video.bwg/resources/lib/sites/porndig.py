...
def Main(name):
    ...
    utils.addDir('[COLOR white]Categories[/COLOR]', 'https://www.porndig.com/videos/', 293, '', '')
    if addon.getSetting("pdsection") == '0':
        utils.addDir('[COLOR white]Studios[/COLOR]', 'https://www.porndig.com/studios/load_more_studios', 294, '', 0)
        utils.addDir('[COLOR white]Pornstars[/COLOR]', 'https://www.porndig.com/pornstars/load_more_pornstars', 295, '', 0)
    List('', 0, 0)
