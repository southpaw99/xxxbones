...
def pl_main():
    utils.addDir('[COLOR white]Categories[/COLOR]','https://porns.land/video-categories', 623, '', '')
    utils.addDir('[COLOR white]Channels[/COLOR]','https://porns.land/video-channels', 624, '', '')
    utils.addDir('[COLOR white]Search[/COLOR]','https://porns.land/search?q=', 625, '', '')
