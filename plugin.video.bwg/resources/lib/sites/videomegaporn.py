...
def Main():
    ...
    '''
    utils.addDir('[COLOR white]Categories[/COLOR]', 'http://www.videomegaporn.com/index.html', 113, '', '')
    utils.addDir('[COLOR white]Search[/COLOR]', 'http://www.videomegaporn.com/search-', 114, '', '')
