...
def XTMain():
    utils.addDir('[COLOR white]Categories[/COLOR]','https://xxxmoviestream.com/categories/',22,'','')
    utils.addDir('[COLOR white]Search[/COLOR]','https://xxxmoviestream.com/page/1/?s=',24,'','')
    Sort = '[COLOR white]Current sort:[/COLOR] ' + sortlistxt[int(addon.getSetting("sortxt"))]
