'''
    ...
    Copyright (C) 2018  WhiteGoo, holisticdioxide
...
def PTMain():
    utils.addDir('[COLOR white]Categories[/COLOR]', 'https://www.porntrex.com/categories/', 53, '', '')
    utils.addDir('[COLOR white]Search[/COLOR]', 'https://www.porntrex.com/search/', 54, '', '')
...
def JHMain():
    utils.addDir('[COLOR white]Categories[/COLOR]', 'https://www.javwhores.com/categories/', 53, '', '')
    utils.addDir('[COLOR white]Search[/COLOR]', 'https://www.javwhores.com/search/', 54, '', '')
