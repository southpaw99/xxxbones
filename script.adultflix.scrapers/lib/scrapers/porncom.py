...
search_tag = 1
search_base = urljoin(base_domain, 'videos/search?q=%s')
...
def content(url, searched=False):
    try:
        ...
        r = [(dom_parser2.parse_dom(i, 'a', req=['href', 'title']), \
             ...
             for i in r if i]
        r = [(urljoin(base_domain, i[0][1].attrs['href']), i[0][1].attrs['title'], i[2][0].content,
              i[1][0].attrs['src']) for i in r if i]
