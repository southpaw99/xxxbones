...
class scraper:
    ...
    def get_list(self, mode, type, url, title_pattern, url_pattern, icon_pattern=None, site=None, d_p1=None, d_p2=None, d_p3=None, parse=None, cache_time=None,searched=False,stopend=False, isVideo=False, isDownloadable = False):
        ...
        if r:
            ...
            for i in r:
                    ...
                    elif site: iconimage = xbmc.translatePath(os.path.join('special://home/addons/script.wankstains.artwork', 'resources/art/%s/icon.png' % site))
                    else: iconimage = xbmc.translatePath(os.path.join('special://home/addons/' + kodi.get_id(), 'icon.png'))
                    fanarts = xbmc.translatePath(os.path.join('special://home/addons/script.wankstains.artwork', 'resources/art/%s/fanart.jpg' % site))
                    if parse: 
    ...
    def get_next_page(self, mode, url, pattern, site='', parse=None, pictures=False):
        ...
        try:
            dirlst = []
            icon = xbmc.translatePath(os.path.join('special://home/addons/script.wankstains.artwork', 'resources/art/main/next.png'))
            fanart = xbmc.translatePath(os.path.join('special://home/addons/script.wankstains.artwork', 'resources/art/%s/fanart.jpg' % site))
            if '|GOT_URL' in url: 
