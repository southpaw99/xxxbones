...
specific_icon       = xbmc.translatePath(os.path.join('special://home/addons/script.wankstains.artwork/resources/art/', '%s/icon.png'))
specific_fanart     = xbmc.translatePath(os.path.join('special://home/addons/script.wankstains.artwork/resources/art/', '%s/fanart.jpg'))

@utils.url_dispatcher.register('0')
def mainMenu():
    
    art = xbmc.translatePath(os.path.join('special://home/addons/script.wankstains.artwork/resources/art/', 'main/%s.png'))

    dirlst = []
    c = []
    
    c += [
         (kodi.giveColor('Welcome to Kodibox Adult Version %s' % kodi.get_version() ,'blue',True),xbmc.translatePath(os.path.join(kodi.addonfolder, 'resources/files/information.txt')),17,'icon','All issues must be reported at https://github.com/stitches5150/xxxbones/issues/ or I will not know the issues exist. I will not provide support at any other location as one central place for everyone to see and discuss issues benefits everyone.',False), \
         (kodi.giveColor(kodi.countGitHubIssues('https://github.com/stitches5150/xxxbones/issues/'),'blue',True) + kodi.giveColor(' | Click To View Issues','white',True),None,34,'report','All issues must be reported at https://github.com/stitches5150/xxxbones/issues/ or I will not know the issues exist. I will not provide support at any other location as one central place for everyone to see and discuss issues benefits everyone.',False), \
         ('Search...',None,29,'search','Search Kodibox Adult',True), \
         ...
         ('View Disclaimer',xbmc.translatePath(os.path.join(kodi.addonfolder, 'resources/files/disclaimer.txt')),17,'disclaimer','View Kodibox Adult Disclaimer.',False), \
         ('View Addon Information',xbmc.translatePath(os.path.join(kodi.addonfolder, 'resources/files/information.txt')),17,'addon_info','View Kodibox Adult Information.',False), \
         ('View Changelog',xbmc.translatePath(os.path.join(kodi.addonfolder, 'changelog.txt')),17,'changelog','View Kodibox Adult Changelog.',False), \
         ('Debug Versions',None,45,'addon_info','View the versions of XXXODUS and its dependencies for debugging.',True), \
         ('RESET Kodibox Adult',None,18,'reset','Reset Kodibox Adult to Factory Settings.',False), \
         (kodi.giveColor('Report Issues @ https://github.com/stitches5150/xxxbones/issues/','violet',True),xbmc.translatePath(os.path.join(kodi.addonfolder, 'resources/files/information.txt')),17,'report','All issues must be reported at https://github.com/stitches5150/xxxbones/issues/ or I will not know the issues exist. I will not provide support at any other location as one central place for everyone to see and discuss issues benefits everyone.',False), \
         ]
