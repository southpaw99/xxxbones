...
def Main():
    utils.addDir('[COLOR white]Categories[/COLOR]','http://streamxxx.tv/', 177, '', '')
    utils.addDir('[COLOR white]Tags[/COLOR]','http://streamxxx.tv/top-tags/', 173, '', '')
    utils.addDir('[COLOR white]Movies[/COLOR]','http://streamxxx.tv/category/movies-xxx/', 175, '', '')
    utils.addDir('[COLOR white]International Movies[/COLOR]','http://streamxxx.tv/category/movies-xxx/international-movies/', 176, '', '')
    utils.addDir('[COLOR white]Search Overall[/COLOR]','http://streamxxx.tv/?s=', 174, '', '')
    utils.addDir('[COLOR white]Search Scenes[/COLOR]','http://streamxxx.tv/?cat=5562&s=', 174, '', '')
