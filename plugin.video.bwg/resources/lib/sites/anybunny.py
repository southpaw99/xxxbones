...
def Main():
    utils.addDir('[COLOR white]Top videos[/COLOR]','http://anybunny.com/top/',321,'','')
    utils.addDir('[COLOR white]Categories - images[/COLOR]','http://anybunny.com/',323,'','')
    utils.addDir('[COLOR white]Categories - all[/COLOR]','http://anybunny.com/',325,'','')
    utils.addDir('[COLOR white]Search[/COLOR]','http://anybunny.com/new/',324,'','')
