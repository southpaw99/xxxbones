...
def XTCMain():
    utils.addDir('[COLOR white]Categories[/COLOR]','http://xtasie.com/video-porn-categories/',203,'','')
    utils.addDir('[COLOR white]Top Rated[/COLOR]','http://xtasie.com/top-rated-porn-videos/',201,'','')
    utils.addDir('[COLOR white]Most Viewed[/COLOR]','http://xtasie.com/most-viewed-porn-videos/',201,'','')
    utils.addDir('[COLOR white]Search[/COLOR]','http://xtasie.com/?s=',204,'','')
