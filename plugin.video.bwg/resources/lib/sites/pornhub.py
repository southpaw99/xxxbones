...
def Main():
    utils.addDir('[COLOR white]Search[/COLOR]','https://www.pornhub.com/video/search?o=mr&search=', 394, '', '')
    utils.addDir('[COLOR white]Categories[/COLOR]','https://www.pornhub.com/categories?o=al', 393, '', '')
