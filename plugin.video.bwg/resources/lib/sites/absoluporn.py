...
def Main():
    utils.addDir('[COLOR white]Top Rated[/COLOR]','http://www.absoluporn.com/en/wall-note-1.html',301,'','')
    utils.addDir('[COLOR white]Most Viewed[/COLOR]','http://www.absoluporn.com/en/wall-main-1.html',301,'','')
    utils.addDir('[COLOR white]Longest[/COLOR]','http://www.absoluporn.com/en/wall-time-1.html',301,'','')
    utils.addDir('[COLOR white]Categories[/COLOR]','http://www.absoluporn.com/en',303,'','')
    utils.addDir('[COLOR white]Search[/COLOR]','http://www.absoluporn.com/en/search-',304,'','')
