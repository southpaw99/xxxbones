...
def Main():
    ...
    utils.addDir('[COLOR white]Featured[/COLOR]','http://www.cam4.com/featured/1',281,'',1)
    utils.addDir('[COLOR white]Females[/COLOR]','http://www.cam4.com/female/1',281,'',1)
    utils.addDir('[COLOR white]Couples[/COLOR]','http://www.cam4.com/couple/1',281,'',1)
    utils.addDir('[COLOR white]Males[/COLOR]','http://www.cam4.com/male/1',281,'',1)
    utils.addDir('[COLOR white]Transsexual[/COLOR]','http://www.cam4.com/shemale/1',281,'',1)
